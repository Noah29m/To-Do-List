...
class ToDoAdapter(context: Context ,toDoList:MutableList<ToDoList>) : BaseAdapter() {
    private val inflater:LayoutInflater= LayoutInflater.from(context)
    private var itemList =toDoList
    private var updateAndDelete =context as UpdateAndDelete
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View? {
        ...
        if (p1 == null){
            view = inflater.inflate(R.layout.raw_layout,p2,false)
